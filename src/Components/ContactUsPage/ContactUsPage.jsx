      ...
      <section className="contact-form-section">
        ...
        {formSubmitted && (
          <div className="form-confirmation">
            ...
            <img src="https://media.giphy.com/media/26BGQWxXZmLP4bpy/giphy.gif" alt="Success" />
          </div>
        )}
      </section>
      ...
      <section className="additional-contact-section">
        <div className="quick-links">
          ...
          <ul>
            ...
            <li><a href="#socials">Follow Us on Social Media</a></li>
          </ul>
        </div>
        ...
        <div className="social-media-section">
          ...
          <div className="social-media-icons">
            <img src="https://www.iconfinder.com/data/icons/social-media-round-icons/512/Instagram-512.png" alt="Instagram" />
            <img src="https://www.iconfinder.com/data/icons/social-media-round-icons/512/Facebook-512.png" alt="Facebook" />
            <img src="https://www.iconfinder.com/data/icons/social-media-round-icons/512/Twitter-512.png" alt="Twitter" />
          </div>
        </div>
      </section>
    </div>
